        ...
        <Paper shadow="md" radius="lg" p="xl" withBorder>
          ...
          <Stack spacing="xs" align="center">
            ...
            <Group spacing={6}>
              ...
              <Text size="md">{userInfo.username}</Text>
            </Group>
            <Group spacing={6}>
              <ThemeIcon color="gray" size="sm" variant="light">
                <IconMail size={16} />
              </ThemeIcon>
              <Text size="md">{userInfo.email}</Text>
        ...
        <Paper shadow="md" radius="lg" p="xl" withBorder>
          ...
          <Stack spacing="sm" align="center">
            {sessionsLoading ? (
              ...
              <Text color="dimmed">No active sessions found.</Text>
            ) : (
              userSessions.map((session: ISession) => (
               <Group position="apart" key={session.id} style={{ width: '100%' }}>
                  <Box>
                    ...
                    <Text size="xs" color="dimmed">IP: {session.ipAddress}</Text>
                  </Box>
                  <Box>
                    <Text size="sm" weight={500}>Last active:</Text>
